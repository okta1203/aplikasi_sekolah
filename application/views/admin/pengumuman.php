...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <?php if ($this->session->flashdata('eror/input')){ ?>
        <script>
            swal({
        title: "Eror!",
    ...
    <?php if ($this->session->flashdata('eror_file_gambar_berita')){ ?>
        <script>
             swal({
        title: "Eror!",
        text: "Data Gagal Ditambahkan",
    ...
    <?php if ($this->session->flashdata('eror/delete')){ ?>
        <script>
            swal({
        title: "Eror!",
                ...
                <div class="container-fluid">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <center>
                                                    <a href="<?=base_url();?>assets/gambar/<?$foto_pengumuman?>"
                                                        target="_blank" rel="Gambar_Pengumuman?">
                                                        <img src="<?=base_url();?>assets/gambar/<?=$foto_pengumuman?>"
                                                            alt="Gambar_Pengumuman" style="width: 25%">
                                                    </a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Edit Pengumuman
                                                        </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?=base_url();?>Data_Pengumuman/edit_pengumuman"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" class="form-control" id="created_at"
                                                                    name="created_at" aria-describedby="emailHelp"
                                                                    value="<?=$created_at?>">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="penulis_pengumuman">Penulis
                                                                    pengumuman</label>
                                                                <input type="text" class="form-control"
                                                                    id="penulis_pengumuman" name="penulis_pengumuman"
                                                                    aria-describedby="emailHelp"
                                        ...
                                        </div> <!-- Modal Hapus Pengumuman -->
                                        <div class="modal fade" id="hapus" tabindex="-1"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Hapus Pengumuman
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?=base_url();?>Data_Pengumuman/hapus_pengumuman"
                                                            enctype="multipart/form-data" method="POST">
                                                            <div class="row">
                                                                <div class="col">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submid" class="btn btn-primary">
                                                                    Iya</button>
                                                            </div>
                                                        </form>
                                                    </div>
                    ...
                    <div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Tambah Pengumuman
                                    </h5>

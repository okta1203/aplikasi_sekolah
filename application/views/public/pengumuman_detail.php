...
<body>
    ...
    <footer id="footer">
        ...
        <div class="container">
            ...
            <div class="credits">
                ...
                <!-- Purchase the pro version with working /AJAX contact form: https://bootstrapmade.com/scaffold-bootstrap-metro-style-template/ -->
    ...
    <script src="<?= base_url();?>assets/public/assets/vendor/-email-form/validate.js"></script>
